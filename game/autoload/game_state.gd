...
func _ready() -> void:
	...
	reset_case()
	var keys := {"move_left": [KEY_A, KEY_LEFT], "move_right": [KEY_D, KEY_RIGHT], "move_up": [KEY_W, KEY_UP], "move_down": [KEY_S, KEY_DOWN], "interact": [KEY_E, KEY_ENTER], "pulse": [KEY_SPACE], "vision": [KEY_Q], "restart": [KEY_F2], "band_fact": [KEY_1], "band_emotion": [KEY_2], "band_expectation": [KEY_3]}
	for action in keys:
