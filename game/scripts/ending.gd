...
func show_reality() -> void:
	...
	portrait_at("林澈", Vector2(20, 145), Vector2(330, 460), Color(0.75, 0.85, 0.92, 0.34), true)
	portrait_at("林父", Vector2(930, 145), Vector2(330, 460), Color(0.72, 0.68, 0.64, 0.30), true)
...
func _draw() -> void:
	if reality:
		...
		draw_actor("怪物", Vector2(212, 620), monster_height, tint)
		if kind == "accept":
